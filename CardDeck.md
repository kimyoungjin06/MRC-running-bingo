...
# A. Base (14장)
A01 ★ 4km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 3km+ / 중수 4km+ / 고수 5km+  
- 증거: 러닝앱 기록

A02 ★★ 6km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 5km+ / 중수 6km+ / 고수 7km+  
- 증거: 러닝앱 기록

A03 ★★ 8km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 7km+ / 중수 8km+ / 고수 9km+  
- 증거: 러닝앱 기록

A04 ★ 35분 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 30분+ / 중수 35분+ / 고수 40분+  
- 증거: 러닝앱 기록

A05 ★★ 50분 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 45분+ / 중수 50분+ / 고수 55분+  
- 증거: 러닝앱 기록
...
A10 ★ 무음 러닝  
- 조건(티어 스케일링): 이어폰/음악 없이 러닝 + (초보 25분+ / 중수 35분+ / 고수 45분+)  
- 증거: 자기보고(짧게)

A11 ★★ 새 코스 개척  
- 조건(티어 스케일링): 이번 달 처음 가는 코스에서 러닝 + (초보 4km+ / 중수 6km+ / 고수 8km+)  
- 증거: 지도 캡처(러닝앱 경로)

A12 ★★ 빌드업(또는 네거티브 스플릿) 러닝  
- 조건(티어 스케일링): 총 러닝시간 (초보 25분+ / 중수 35분+ / 고수 45분+) + 마지막 10분 평균페이스가 첫 10분보다 빠름  
- 증거: 스플릿/랩 캡처(가능하면)
