...
- **D Marathon(누적/연속)**: 여러 날 누적 목표(완성되는 러닝에서 체크, 총 3칸 제한에 포함)
...
# A. Base (14장)
A01 ★ 3km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 2km+ / 중수 3km+ / 고수 4km+  
- 증거: 러닝앱 기록

A02 ★★ 5km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 4km+ / 중수 5km+ / 고수 6km+  
- 증거: 러닝앱 기록

A03 ★★★ 7km 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 6km+ / 중수 7km+ / 고수 8km+  
- 증거: 러닝앱 기록

A04 ★ 30분 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 25분+ / 중수 30분+ / 고수 35분+  
- 증거: 러닝앱 기록

A05 ★★★ 45분 이상 러닝(중수 기준)  
- 조건(티어 스케일링): 초보 40분+ / 중수 45분+ / 고수 50분+  
- 증거: 러닝앱 기록

A06 ★ 워밍업 5분 + 러닝  
- 조건: 러닝 전 동적 스트레칭/워밍업 5분 수행  
...
A10 ★ 무음 러닝  
- 조건(티어 스케일링): 이어폰/음악 없이 러닝 + (초보 20분+ / 중수 30분+ / 고수 40분+)  
- 증거: 자기보고(짧게)

A11 ★★ 새 코스 개척  
- 조건(티어 스케일링): 이번 달 처음 가는 코스에서 러닝 + (초보 3km+ / 중수 5km+ / 고수 7km+)  
- 증거: 지도 캡처(러닝앱 경로)

A12 ★★ 빌드업(또는 네거티브 스플릿) 러닝  
- 조건(티어 스케일링): 총 러닝시간 (초보 20분+ / 중수 30분+ / 고수 40분+) + 마지막 10분 평균페이스가 첫 10분보다 빠름  
- 증거: 스플릿/랩 캡처(가능하면)

A13 ★★ 러닝 드릴 5분  
- 조건: 스킵/런지워크/러닝폼 드릴 등 5분  
- 증거: 자기보고(드릴명 1줄)
